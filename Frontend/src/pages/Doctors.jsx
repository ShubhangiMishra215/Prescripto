      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-5">
        ...
        >
          <p
            ...
            className={`w-[94vw] sm:w-auto pl-3 pr-16 border border-gray-300 rounded transition-all cursor-pointer 
        ...
        <div className="w-full grid grid-cols-[var(--grid-cols-auto)] gap-4 pt-5 gap-u-6 px-3 sm:px-0' gap-4 gap-y-6">
